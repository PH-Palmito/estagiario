...
CHATTER_PATTERNS = {
    ...
    "qual o nome do projeto": "O projeto se chama Axel. E o assistente local que estamos construindo para voz, arquivos, estudos, automacoes e controle do computador.",
    "qual e o nome do projeto": "O projeto se chama Axel. E o assistente local que estamos construindo para voz, arquivos, estudos, automacoes e controle do computador.",
