...
GOLDEN_COMMANDS = [
    ...
    ("o que mudou na carteira desde ontem", "investment_daily_report", {}),
    ...
    ("status do calendario", "agenda_calendar_status", {}),
    ("exportar calendario", "agenda_export_ics", {"path": ""}),
    ...
    ("status do led do teclado", "keyboard_led_status", {}),
    ("ligar led do teclado azul", "keyboard_led_on", {"color": "azul"}),
    ("desligar led do teclado", "keyboard_led_off", {}),
